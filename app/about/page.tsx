  ...
  return (
    <div className='space-y-12'>
      <div className='space-y-4'>
        <div className='flex md:space-x-16'>
          <div className='space-y-4 text-lg md:w-2/3'>
            ...
            <p>Hi, I'm Manuel. :)</p>
            <p>
              Originally, I'm from Switzerland but for the last two years I've
              been{' '}
            ...
            <p>
              I'm a passionate{' '}
              <span className='accentText-noUnderline'> developer </span> - I
              work at{' '}
              <Link
                href='https://www.owt.swiss/en/'
                target={'_'}
                className='accentText'
              >
                OWT
              </Link>
              , the consulting subsidiary of Switzerland's largest telecom
              company.
            </p>
            <p>
              I'm also studying law at university, run my own content writing
              agency and build side projects in my free time.
            </p>
          </div>
      ...
      <div className='space-y-4'>
        ...
        <p className='text-lg'>
          These are some projects I'm currently working on. Some are already
          full-fledged products, others are just ideas or prototypes.
        </p>
        <SideProjects />
      </div>
    </div>
